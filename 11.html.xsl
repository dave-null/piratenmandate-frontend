...
<xsl:template match="bundesland" mode="abstract">
	...
	<p>Einen Teil dieser Aufgaben überlässt die Landesregierung den Bezirken. Sie werden von den direkt gewählten Bezirksverordnetenversammlungen kontrolliert. Diese wählen den Bezirksbürgermeister und die fünf Bezirksstadträte, die das Bezirksamt leiten. Darüber hinaus ist ihr Einfluss auf das Bezirksamt sehr begrenzt (<a href="http://de.wikipedia.org/wiki/Bezirksverordnetenversammlung">Wikipedia</a>).</p>
